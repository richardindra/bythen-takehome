...
// Patch executes http PATCH request with the given body & headers.
// The supported data types for body are:
// - string
// - []byte
// - struct/map/slice : will be marshalled to JSON
// - io.Reader
func (c *Client) Patch(ctx context.Context, url string, headers http.Header, body interface{}) (*http.Response, error) {
	return c.doMethod(ctx, http.MethodPatch, url, body, headers)
}

// PatchJSON executes http PATCH request with the given body & headers and parse the json response body
// into the given data.
// The supported data types for body are:
// - string
// - []byte
...
// - io.Reader
// The returned response Body is already closed
func (c *Client) PatchJSON(ctx context.Context, url string, headers http.Header, body, data interface{}) (*http.Response, error) {
	return c.doMethodJSON(ctx, http.MethodPatch, url, body, headers, data)
}

// Delete executes http DELETE request with the given body & headers.
// The supported data types for body are:
// - string
// - []byte
// - struct/map/slice : will be marshalled to JSON
// - io.Reader
func (c *Client) Delete(ctx context.Context, url string, headers http.Header, body interface{}) (*http.Response, error) {
	return c.doMethod(ctx, http.MethodDelete, url, body, headers)
}

// DeleteJSON executes http DELETE request with the given body & headers and parse the json response body
// into the given data.
// The supported data types for body are:
// - string
// - []byte
...
// - io.Reader
// The returned response Body is already closed
func (c *Client) DeleteJSON(ctx context.Context, url string, headers http.Header, body, data interface{}) (*http.Response, error) {
	return c.doMethodJSON(ctx, http.MethodDelete, url, body, headers, data)
}

// do specific request
func (c *Client) doMethod(ctx context.Context, method, url string, body interface{}, headers http.Header) (*http.Response, error) {
